...
[![Tests](https://img.shields.io/badge/tests-1034%20passing-brightgreen.svg)](backend/tests)
[![Python](https://img.shields.io/badge/python-3.12-blue.svg)](backend/requirements.txt)

Merlon runs 41 detection engines over a target, normalises everything they
...
>
> * **Detection is not exhaustive.** 41 engines cover exposure and
...
```bash
cd backend && python -m pytest tests/ -q     # 1034 unit tests, no network
